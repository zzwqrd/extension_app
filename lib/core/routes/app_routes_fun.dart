...
Future<dynamic> push(String named, {dynamic arguments}) {
  return Navigator.of(
    navigatorKey.currentContext!,
  ).push(SlideRight(named: named, arguments: arguments));
}

Future<dynamic> replacement(String named, {dynamic arguments}) {
  return Navigator.of(
    navigatorKey.currentContext!,
  ).pushReplacement(SlideRight(named: named, arguments: arguments));
}
